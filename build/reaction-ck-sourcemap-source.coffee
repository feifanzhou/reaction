 ...
 * deterministic ordering of EventPlugins. A convenient way to reason about
...
var ReactEventEmitter = merge(ReactEventEmitterMixin, {
   ...
   * catch all mousemoves. This along with iOS quirks, justifies restricting
...
var ReactEventEmitterMixin = {
   ...
   * opportunity to create ReactEvents to be dispatched.
   *
   * @param {string} topLevelType Record from EventConstants.
...
mergeInto(SyntheticEvent.prototype, {
  ...
  /**
   * We release all dispatched SyntheticEvents after each event loop, adding
...
var Mixin = {
   ...
   * (closers that correspond to initializers that failed will not be
   * invoked).
   */
...
var mergeHelpers = {
   ...
   * but one and two being Arrays, it is the fault of the merge utilities.
   *
